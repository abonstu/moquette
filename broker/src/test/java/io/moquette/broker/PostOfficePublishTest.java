...
public class PostOfficePublishTest
{
	...
	static final BrokerConfiguration	ALLOW_ANONYMOUS_AND_ZERO_BYTES_CLID	= new BrokerConfiguration( true, true, false, false );
	...
	public void testPublishWithEmptyPayloadClearRetainedStore()
	{
		...
		this.retainedRepository.retain(
				new Topic( NEWS_TOPIC ),
				MqttMessageBuilders.publish()
